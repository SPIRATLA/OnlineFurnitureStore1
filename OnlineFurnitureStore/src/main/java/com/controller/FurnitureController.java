...
public class FurnitureController 
{
	...
	public Furniture deleteFurnitureByID(@PathVariable("furnitureId") int furnitureId) throws FurnitureServiceException 
	{
	...
	@GetMapping(path = "/getFurnitureDetails/{furnitureId}")
	public ResponseEntity<Furniture> getFurnitureDetails(@PathVariable("furnitureId") int furnitureId)throws FurnitureServiceException {
